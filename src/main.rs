...
fn main() {
    ...
    unsafe {
        ...
        call_set_builder(handle, builder);
        let window = gtk::Window::new();
        call_set_window(handle, window);
        call_main(handle);
...
unsafe fn call_main(handle: *mut libc::c_void) {
...
unsafe fn call_set_builder(handle: *mut libc::c_void, builder: gtk::Builder) {
...
unsafe fn call_set_window(handle: *mut libc::c_void, window: gtk::Window) {
